...
ROUTES: tuple[ApiRoute, ...] = (
    ...
    ApiRoute("allocation.health", "GET", "/api/allokering/health", "Allokering health"),
    ApiRoute("allocation.flows", "GET", "/api/allokering/flows", "Lista Allokering-flöden"),
    ApiRoute("allocation.pool", "GET", "/api/allokering/pool", "Lista Allokering-uppladdningsslots"),
    ApiRoute("allocation.detect", "POST", "/api/allokering/detect", "Identifiera Allokering-fil"),
    ApiRoute("allocation.observations_update", "POST", "/api/allokering/observations/update", "Uppdatera observations från buffert"),
    ApiRoute("allocation.run_flow", "POST", "/api/allokering/flow/{flow_id}", "Kör Allokering-flöde"),
    ApiRoute("allocation.open_excel", "POST", "/api/allokering/open-excel", "Öppna Allokering-resultat i Excel"),
