...
PAGES: tuple[VisualPage, ...] = (
    ...
    VisualPage("mcp", "/mcp.html", "#mcpQuestion", ("admin",)),
    VisualPage("etiketter", "/label-editor.html", "#labelCanvas .label-object", ("admin",)),
    VisualPage("dubbletter", "/dubbletter.html", "#dedupeInput", ("admin",)),
