...
| Ny handelse/integration/hardvara | API-/domantest for handelsen, audit-test for `entity_type`/`action`, Historik/Analys-label i frontend/backend, verksamhetsscope och minst ett fel-/okant-lage. Hardvara far mockas; manuell scanning ar bara komplement. |
