...
| Redigera kluster | Visas i Forecast-resultatet nar Forecast har transportorer. Oppnar en modal dar anvandaren kan andra kluster, UTL-fran/till och ordning for den aktuella Forecast -> Ytgenerering-kedjan. Om `trans_agency` inte gav klusterrader skapas raderna fran Forecast-tabellens unika transportorer. |
