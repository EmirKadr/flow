...
| Radera | `meta.html` | Super User | Papperskorg-knapp oppnar en bekraftelsemodal (`Avbryt`/`Radera`). Vid bekraftelse tas hela videon och alla spar bort permanent: sandningsraden, videofilen ur MediaStore (om ingen annan rad delar samma innehallshash) och etikettreferenser. | `DELETE /api/meta/uploads/{upload_id}` | 403 om anvandaren inte ar Super User. 404 om raden redan ar borta. Kan inte angras. |
