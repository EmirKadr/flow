        ...
        InteractionEventBatchIn(
            items=[
                InteractionEventIn(
                    event_type="copy",
                    view_id="allocationProcess",
                    page_path="/bearbeta.html?private_field=VALUE_TO_DROP",
                    control_id="allocation-copy-column",
                    feature="allocation",
                    flow_id="pafyllnadsprio",
                    detail={
                        "password": "VALUE_TO_DROP",
                        "cookie": "VALUE_TO_DROP",
                        "authorization_header": "VALUE_TO_DROP",
                        "api_key": "VALUE_TO_DROP",
                        "endpoint_url": "https://example.invalid/drop",
                        "request_body": {"order": "VALUE_TO_DROP"},
                        "file_name": "drop-file.csv",
                        "file_path": "C:/example/drop-file.csv",
                        "localRef": "VALUE_TO_DROP",
                        "value_sample": "hemligt cellvarde",
