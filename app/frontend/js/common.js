...
window.syncViewTabs = syncViewTabs;
window.syncToolsTabs = syncToolsTabs;
...
window.areaFocusListParams = areaFocusListParams;
window.matchesAreaFocusBusiness = matchesAreaFocusBusiness;
window.areaFocusName = areaFocusName;
window.readBusinessFocus = readBusinessFocus;
window.writeBusinessFocus = writeBusinessFocus;
window.businessFocusBusinessId = businessFocusBusinessId;
window.businessFocusName = businessFocusName;
