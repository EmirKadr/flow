...
KNOWN_INTERACTION_CONTROLS = [
    ...
    {"view_id": "persons", "control_id": "newPerson", "label": "Ny person"},
    {"view_id": "persons", "control_id": "bulkPersons", "label": "Flera nya personer"},
    {"view_id": "persons", "control_id": "importPersons", "label": "Importera personer"},
    {"view_id": "activities", "control_id": "newActivity", "label": "Ny aktivitet"},
    {"view_id": "activities", "control_id": "bulkActivities", "label": "Flera nya aktiviteter"},
    {"view_id": "users", "control_id": "newUser", "label": "Ny anvandare"},
    {"view_id": "users", "control_id": "roleAccess", "label": "Vybehorigheter"},
    {"view_id": "businesses", "control_id": "new-business", "label": "Ny verksamhet"},
    {"view_id": "productivity", "control_id": "productivityPrevDate", "label": "Foregaende datum"},
    {"view_id": "productivity", "control_id": "productivityNextDate", "label": "Nasta datum"},
